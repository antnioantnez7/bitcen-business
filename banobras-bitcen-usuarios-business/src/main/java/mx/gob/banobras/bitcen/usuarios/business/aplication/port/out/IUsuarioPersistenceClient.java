package mx.gob.banobras.bitcen.usuarios.business.aplication.port.out;
/**
 * IUsuarioPersistenceClient.java:
 * 
 * Interface para el cliente de conexion a la capa de pesistencia de usuarios.
 * 
...
public interface IUsuarioPersistenceClient  {
	 ...
	 * @throws Exception
	 */
	ResponseUsuarioDTO registrar(HeaderDTO headerDTO, BitacoraUsuarioDTO bitacoraUsuarioDTO) 
			throws Exception; 
	/**
